...
To enable collaborative approvals across slack, email, and other channels, you'll need to connect the humanlayer SDK to a server. The easiest way to do this is to log into https://app.humanlayer.dev and create a new project and API token, then set it in your shell environment or `.env` file:
